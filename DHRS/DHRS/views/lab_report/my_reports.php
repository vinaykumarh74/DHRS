<?php
/**
 * Lab Reports View for Citizens
 */

// Set page title
$page_title = 'My Lab Reports';
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item px-0 active">
                            <a href="index.php?controller=lab_report&action=my_reports" class="text-decoration-none text-white">
        ...
        <div class="col-lg-9">
            <div class="card mb-4">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    <h4 class="mb-0"><i class="fas fa-flask me-2"></i>My Lab Reports</h4>
                    <div>
                        <span class="badge bg-light text-dark"><?php echo count($lab_reports); ?> Reports</span>
                    </div>
                </div>
                <div class="card-body">
                    <?php if (empty($lab_reports)): ?>
                        <div class="text-center py-5">
                            ...
                            <p class="text-muted">You don't have any lab reports yet. Reports will appear here after your lab tests are completed.</p>
                        </div>
                    <?php else: ?>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex flex-column">
                                                    <span class="fw-bold"><?php echo date('M d, Y', strtotime($report['report_date'])); ?></span>
                                                    <small class="text-muted"><?php echo date('h:i A', strtotime($report['created_at'])); ?></small>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex flex-column">
                                                    <span class="fw-bold"><?php echo htmlspecialchars($report['test_name']); ?></span>
                                                    <small class="text-muted"><?php echo htmlspecialchars(substr($report['test_description'], 0, 50)) . (strlen($report['test_description']) > 50 ? '...' : ''); ?></small>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex flex-column">
                                                    <span class="fw-bold"><?php echo htmlspecialchars($report['lab_name']); ?></span>
                                                    <?php if (!empty($report['technician_name'])): ?>
                                                        <small class="text-muted">Tech: <?php echo htmlspecialchars($report['technician_name']); ?></small>
                                                    <?php endif; ?>
                                                </div>
                                            </td>
                                            <td>
                                                <?php if (!empty($report['first_name'])): ?>
                                                    <div class="d-flex flex-column">
                                                        <span class="fw-bold">Dr. <?php echo htmlspecialchars($report['first_name'] . ' ' . $report['last_name']); ?></span>
                                                        <small class="text-muted"><?php echo htmlspecialchars($report['specialization']); ?></small>
                                                    </div>
                                                <?php else: ?>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <a href="index.php?controller=lab_report&action=view&id=<?php echo $report['id']; ?>" class="btn btn-sm btn-outline-primary">
                                                        <i class="fas fa-eye me-1"></i>View
                                                    </a>
                                                    <a href="index.php?controller=lab_report&action=download&id=<?php echo $report['id']; ?>" class="btn btn-sm btn-outline-success">
